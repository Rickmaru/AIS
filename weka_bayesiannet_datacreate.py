...
def judgger(tok):
    if '名詞' in tok.part_of_speech and '数' not in tok.part_of_speech and tok.base_form !="*" and tok.base_form !="['" and tok.base_form !="']" and tok.base_form !="）']":
        return True
    elif "動詞" in tok.part_of_speech and tok.base_form !="*" and tok.base_form !="['" and tok.base_form !="']" and tok.base_form !="）']":
        return True
    else:
        return False
